...
4. One day’s events must use the correct calendar date.
5. Do NOT hallucinate new places.
6. Output ONLY valid JSON.
7. DO NOT add explanations or markdown.
  ...
  "events": [
    {
      "summary": "",
      "location": "",
      "description": "Generated by TN.AI Planner",
      "start": {
        "dateTime": "",
        "timeZone": "Asia/Kolkata"
      },
...
`;
            ...
            alert("Failed to generate calendar events: " + err.message);
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="modal-overlay" onClick={() => setShowCalendarModal(false)}>
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        <div className="modal-header">
                            <h3><i className="fa-solid fa-calendar-check"></i> Google Calendar Events</h3>
                            <button className="close-modal" onClick={() => setShowCalendarModal(false)}>
                                <i className="fa-solid fa-xmark"></i>
                            </button>
                        </div>
                        <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
                            Copy this JSON to import as events in your Google Calendar.
                        </p>
                        <div className="json-container">
                            {calendarJson}
                        </div>
                        <div className="modal-actions">
                            <button className="action-btn" onClick={() => copyToClipboard(calendarJson)}>
                                <i className="fa-regular fa-copy"></i> Copy JSON
                            </button>
                            <button className="action-btn" onClick={() => setShowCalendarModal(false)} style={{ background: 'var(--accent-soft)', color: 'var(--accent-primary)', border: 'none' }}>
                                Close
                            </button>
                        </div>
                    </div>
